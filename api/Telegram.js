...
Invite friends and earn 200 DPS per referral.`;  
  ...
  bot.start(async (ctx) => {  
    ...
    await ctx.reply(`👋 Welcome to DPS Digital Wallet/nExperience the next generation of digital finance. Seamlessly send, receive, and swap tokens with professional-grade security and blazing-fast speed/n/n💎 Start building your DPS portfolio today! `, {  
        reply_markup: {  
          inline_keyboard: [  
            [{ text: "🚀 Open DPS Wallet App", url: WEB_APP_URL }],  
